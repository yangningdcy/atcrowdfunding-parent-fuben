                    ...
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <c:forEach items="${page.list}" var="admin" varStatus="status">
                                <tr>
                                    <td>${status.count}</td>
                                    <td><input class="itemCheckboxClass" adminId="${admin.id}" type="checkbox"></td>
...
<script type="text/javascript">
    ...
    function deleteAdmin(loginacct,id) {
        //layer弹层组件
        layer.msg("有反应");
        layer.confirm("确定删除【"+loginacct+"】账号吗",{btn:['确定','取消']},function (){
    ...
    $("#deleteBatchBtn").click(function () {
            ...
            var idStr='';
            $.each(checkedboxList,function (i,e) {//i索引  e元素
                //var adminId=e.adminId;//获取元素自定义属性，这样获取拿不到
                var adminId=$(e).attr("adminId");//将dom对象转换为$对象
